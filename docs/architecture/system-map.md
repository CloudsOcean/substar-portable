...
|---|---|---|---|---|---|---|
| `split_ui` | `frontend_connector` | Collect media, source-language-aware normal/reference-script segmentation settings and frozen break symbols, create projects, and project durable task progress. | `web/split.js` | `project_creation_projection` | `project_creation_request` | `composition_root`<br>`editor_api` |
