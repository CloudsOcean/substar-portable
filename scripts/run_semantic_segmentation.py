...
def main(
    ...
    *,
    ...
    parser.add_argument("--chinese-hard-limit", type=int, default=28)
    ...
    parser.add_argument("--japanese-hard-limit", type=int, default=32)
    parser.add_argument("--korean-hard-limit", type=int, default=40)
