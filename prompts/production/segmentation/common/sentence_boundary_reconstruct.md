...
Native ASR sentence boundaries are intentionally unavailable. Reconstruct clauses, sentences, discourse acts, meaning groups and display Cues directly from the continuous repaired word-level timeline.
...
- First recover the most coherent clause and meaning-group structure across the whole owner block, then choose display boundaries within it.
